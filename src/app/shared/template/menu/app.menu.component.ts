    ...
    template: `
        <div class="layout-sidebar" [ngClass]="{'active': active}">
            ...
            <div class="layout-sidebar-filter p-fluid p-input-filled">
                <p-autoComplete [group]="true" [(ngModel)]="selectedRoute" [minLength]="2" [suggestions]="filteredRoutes" scrollHeight="300px" (onSelect)="onSelect($event)" placeholder="Procurar por nome" (completeMethod)="filterGroupedRoute($event)" field="label">
                </p-autoComplete>
            </div>
            <div class="layout-menu">
                <div class="menu-category">Cadsatro</div>
                <div class="menu-items">
                    <a [routerLink]=" ['/home']" routerLinkActive="router-link-exact-active">Home</a>
                </div>
                <div class="menu-items">
                    <a [routerLink]=" ['/cliente']" routerLinkActive="router-link-exact-active">Cliente</a>
                </div>
            </div>
        </div>
    `,
